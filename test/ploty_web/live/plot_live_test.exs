defmodule PlotyWeb.PlotLiveTest do
  use PlotyWeb.ConnCase
  ...
  defp login_user_and_create_plot(%{conn: conn}) do
    password = valid_user_password()
    user = user_fixture(%{password: password})
    plot = plot_fixture(%{creator_id: user.id})
    %{conn: log_in_user(conn, user), user: user, plot: plot}
  end

  describe "Index" do
    setup [:login_user_and_create_plot]
